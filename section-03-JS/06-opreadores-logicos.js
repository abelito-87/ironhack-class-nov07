// que es un opreador----> simbolo especial que nos ayuda a ejecutar operaciones en operando.
...
console.log(`The comparison of these numbers is: ${numberA < 6 && numberB < 5}`);
